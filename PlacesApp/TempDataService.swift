...
class TempDataService {
    ...
    static let shared = TempDataService()
    
    func createTempData(completion: @escaping () -> Void) {
        if !UserDefaults.standard.bool(forKey: "TempData") {
            
            let bolshoi = Place(name: "Большой театр",
                                location: "Театральная площадь, 1, Москва, Россия",
                                type: "Театр",
                                imageData: nil,
                                rating: 5)
            ...
            let mcDonalds = Place(name: "McDonalds",
                                  location: "Газетный переулок, 17, Москва, Россия",
                                  type: "Фастфуд",
                                  imageData: nil,
                                  rating: 5)
            ...
            let mipt = Place(name: "МФТИ",
                             location: "Институтский пер., 9, Долгопрудный, Россия",
                             type: "Университет",
                             imageData: nil,
                             rating: 5)
            ...
            let tretyakov = Place(name: "Третьяковская галерея",
                                  location: "Лаврушинский пер., 10, стр. 4, Москва, Россия",
                                  type: "Музей",
                                  imageData: nil,
                                  rating: 5)
            ...
            let zaryadye = Place(name: "Зарядье",
                                 location: "ул. Варварка, 6, стр. 1, Москва, Россия",
                                 type: "Парк",
                                 imageData: nil,
                                 rating: 5)
            ...
            DispatchQueue.main.async {
                StorageService.shared.saveObjects(places)
